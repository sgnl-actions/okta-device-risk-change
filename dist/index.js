...
var script = {
  /**
   * Main execution handler - transmits an Okta Device Risk Change event as a Security Event Token
   *
   ...
   * @param {string} params.previous_level - Previous device risk level
   * @param {string} params.current_level - Current device risk level
   * @param {string} params.initiating_entity - Entity that initiated the device risk change (optional)
  ...
  invoke: async (params, context) => {
    ...
    const setPayload = {
      aud: params.audience,
      events: {
        [DEVICE_RISK_CHANGE_EVENT]: eventPayload
      }
    };
